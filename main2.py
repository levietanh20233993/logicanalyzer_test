...
COM_PORT       = "COM7"
BAUD_RATE      = 921600
SAMPLE_RATE_HZ = 500_000     # phai khop SAMPLE_FREQ_HZ trong main.c (RP2040)
...
def draw_topbar(surf, font_xs, font_b, wx, ww, n_samples_visible, elapsed,
    ...
    right = ("[ESC] Thoat   [+/-] Zoom   [Scroll] Zoom   [Z] Dung/Tiep tuc   "
...
def display_process(shared):
    ...
    while True:
        ...
        if not user_stopped:
            pull_new_samples(shared, history_ch1, history_ch2, history_ts, MAX_HISTORY)
